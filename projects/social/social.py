...
class SocialGraph:
    ...
    def populate_graph(self, num_users, avg_friendships):
        ...
        # Add users using num_users
        for user in range(num_users):
            self.add_user(user)

        # Create friendships
        """
        # * make list of all POSSIBLE friendships
        ...
        # take as many friendships as needed
        total_friendships = num_users * avg_friendships

        # random_friendships = friendships[:total_friendships//2]

        # add to self.friendships
        for friendship in friendships[:total_friendships//2]:
...
if __name__ == '__main__':
    ...
    connections3 = sg.get_all_social_paths(3)
    print("connections1", connections1)
    print("connections3", connections3)
